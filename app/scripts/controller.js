 ...
 SimController.prototype.setupDisplay = function() {
    ...
    this.simModel.filterExpression.randomFilterExpression();
    ...
    this.simModel.questionBank.setAnswers(this.simModel.filterExpression);
    ...
    this.simView.filterView.drawFilterExpression(this.simModel.filterExpression);
